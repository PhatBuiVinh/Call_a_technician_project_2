      ...
      <div className="space-y-6">
        {loading && (
          <div className="surface rounded-2xl border-brand-sky/20 bg-brand-sky/10 p-8 text-center">
            ...
            <h2 className="text-lg font-semibold text-white">Loading your jobs</h2>
            <p className="mt-2 text-sm leading-6 text-slate-300">Loading your jobs...</p>
          </div>
        )}
        ...
        {error && (
          <div className="surface rounded-2xl border-rose-400/35 bg-rose-500/10 p-6 text-center">
            ...
            <h2 className="text-lg font-semibold text-white">Jobs could not load</h2>
        ...
        {!loading && !error && jobs.length === 0 && (
          <div className="surface rounded-2xl border-white/10 bg-white/[0.04] p-8 text-center">
            ...
            <p className="text-lg font-semibold text-white">No jobs assigned yet</p>
            <p className="mt-2 text-sm leading-6 text-slate-300">New assignments will appear here automatically.</p>
          </div>
        )}
